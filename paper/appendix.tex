...
A separate 27B experiment is retained as a systems result. It changes the actor scale and therefore cannot identify the contribution of controller target parameterization. CAMELS-CIS is outside this paper. The released evidence index preserves those boundaries rather than using favorable actor or domain subsets to replace the frozen confirmation.
