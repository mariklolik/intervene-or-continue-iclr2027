...
\input{generated/r2_temperature.tex} The released evidence index preserves those boundaries rather than using favorable actor or domain subsets to replace the frozen confirmation.
