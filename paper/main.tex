...
The controller comparison holds the development records, observable prefix features, four task-group folds, 200-tree capacity, margin grid, and action menu fixed. One forest predicts arm outcomes. A second predicts signed benefits relative to continuation,
\begin{equation}
