...
\midrule
\multirow{6}{*}{Scheduled} & Continue & 52.86 & 0.0 & 0 & 0 \\
...
Scheduled eligible prefixes & 406 \\
Scheduled prefix digest & \texttt{0f5a80d1...46e863} \\
Scheduled prediction digest & \texttt{78380914...f6911b} \\
\bottomrule
\end{tabular}
\end{table}
